...
export default function EventDetails3({navigation}) {
    ...
    <SafeAreaView>
      ...
      <View>
        ...
        <Image style={styles.flyerImg} source={require('/Users/deandretaylor/ChreaApp/Images/Img3.jpg')}></Image>
        <View style={{flexDirection:'row'}}>
            <View>
                <Text style={styles.heading}>The Levee </Text>
                <Text style={styles.address}>16 W 43rd St, Kansas City, MO 64111</Text>
                <Text style={styles.details}>March 23rd | 4PM-3AM | Ages: 21+ | Bar</Text>
            </View>
            <View style={{width: 122}}>
                ...
                <Text style={styles.directions} onPress={() => {Linking.openURL("https://www.google.com/maps/place/Levee+Bar+%26+Grill/@39.0495116,-94.5916472,17z/data=!3m1!4b1!4m6!3m5!1s0x87c0efc3eeed6e1d:0xc354ebba558f546b!8m2!3d39.0495117!4d-94.5871625!16s%2Fm%2F0k0w92z")}}>Directions</Text>
            </View>
        </View>
        <View style={{flexDirection: 'row'}}>
            <Image style={styles.promoterImgM} source={require('../Images/Headshot1.jpg')}></Image>
            <Text style={styles.promoterNameM}>Promoted by Joseph K.</Text>
        </View>
        <View>
